...
import { addCategory, updateCategories, deleteCategories as deleteCategoriesAction } from "../../redux/actions/category.action";
...
export default function Category() {
  ...
  const deleteCategories = () => {
    ...
    const idArray = expandedIdArray.concat(checkIdArray);
    dispatch(deleteCategoriesAction(idArray))
  }
  const renderDeleteCategoryModel = () => {

    return <Modal show={deleteCategoryModal} onHide={() => setDeleteCategoryModal(false)}>
